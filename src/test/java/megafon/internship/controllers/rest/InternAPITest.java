...
public class InternAPITest {
    ...
    static void loggingInToTakeJsonWebToken() throws IOException {
        ...
        params.add(new BasicNameValuePair("username", "sardor.mentor@megafon.ru"));
        params.add(new BasicNameValuePair("password", "SSss1112"));
        httpPost.setEntity(new UrlEncodedFormEntity(params, "UTF-8"));

        String forEncoding = "sardor.mentor@megafon.ru:SSss1112";
        ...
        File file = new File("JwtForInternAPITest.txt");
        file.createNewFile();
        FileWriter fileWriter = new FileWriter("JwtForInternAPITest.txt");
    ...
    public void testGetUser() throws Exception {
        ...
        HttpGet httpGet = new HttpGet( "http://localhost:8080/api/interns" );
